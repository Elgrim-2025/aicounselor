export const SCENARIOS = [
  {
    ...
    type: 'chat',
    turns: [
      { who: 'me', type: 'text', text: '저기... 할 말이 있어. 어제 학교에서 애들 몇 명이 나를 때렸어.' },
      { who: 'bot', type: 'text', text: '그랬구나, 용기 내서 말해줘서 다행이야. 많이 놀라고 아팠겠다. 지금 몸은 괜찮아? 어디 다친 데는 없어?' },
  ...
  },
  {
    ...
    type: 'chat',
    turns: [
      { who: 'me', type: 'text', text: '있잖아... 요즘 아무것도 하기 싫고 재미가 없어. 학교 가는 것도 힘들어.' },
      { who: 'bot', type: 'text', text: '그런 마음이었구나. 혼자 힘들었겠다. 언제부터 그런 기분이 들었어?' },
  ...
  },
  {
    ...
    type: 'chat',
    turns: [
      { who: 'me', type: 'text', text: '저... 고민이 있어서 그런데. 고2인데 아직도 뭘 하고 싶은지 모르겠어. 다들 뭔가 정한 것 같은데 나만 없는 느낌이야.' },
      { who: 'bot', type: 'text', text: '그런 고민이 있었구나. 조급한 마음이 들 수 있지. 평소에 시간 가는 줄 모르고 좋아하는 활동이 있어?' },
